            ...
            <GoogleLogin
              ...
              render={(renderProps) => (
                <button
                  ...
                  className="bg-white text-black w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium  hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400"
                >
                  Sign In With Google
                </button>
              )}
